...
* [Secrets Manager client](https://github.com/awslabs/aws-greengrass-labs-secretmanagerclient): This component provides a CLI tool that can be used by other components needing to retrieve secrets from the SecretManager component in a recipe lifecycle script.
