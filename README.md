...
* [S3 file uploader](https://github.com/awslabs/aws-greengrass-labs-s3-file-uploader): This component monitors a local directory for new files, upload them to S3 and delete them upon successful upload.
